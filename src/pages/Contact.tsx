    ...
    <Layout>
      <section className="relative py-14 md:py-32 overflow-hidden">
        ...
        <div className="container max-w-3xl">
          ...
          >
            <h1 className="font-heading text-4xl md:text-7xl font-bold mb-3 md:mb-4"><span className="text-foreground">GET IN </span><span className="text-foreground/90 text-serif-italic italic">touch</span></h1>
